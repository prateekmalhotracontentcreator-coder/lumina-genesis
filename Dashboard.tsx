...
const Dashboard: React.FC<DashboardProps> = ({ setActiveView, points }) => {
  ...
  useEffect(() => {
    getDailyVerseInsights(dailyVerse.text).then(setInsight);
  }, []);
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <section 
        ...
        className="glass p-6 border-white/10 bg-gradient-to-r from-blue-600/10 to-indigo-600/10 flex justify-between items-center cursor-pointer hover:bg-white/10 transition-all"
      >
      ...
      <section 
        ...
        className="glass p-6 border-indigo-500/20 bg-indigo-500/5 flex justify-between items-center cursor-pointer hover:bg-indigo-500/10 transition-all border-l-4"
      >
        <div className="flex items-center gap-3">
          <span className="text-2xl">🌈</span>
          <div>
