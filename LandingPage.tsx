    ...
    <div className={`min-h-screen bg-[#0f1018] text-white selection:bg-indigo-500 selection:text-white pb-20 transition-all duration-1000 ${isEntering ? 'scale-105 opacity-0 filter blur-xl' : ''}`}>
      ...
      <nav className="fixed top-0 w-full z-50 glass rounded-none border-x-0 border-t-0 border-white/5 px-6 py-4 flex justify-between items-center bg-black/40 backdrop-blur-md">
        <div className="text-2xl font-bold serif flex items-center gap-2">
          <span className="text-indigo-500">✨</span> {APP_CONFIG.name}
        </div>
      ...
      <section id="features" className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass p-8 space-y-4 hover:bg-white/5 transition-colors border border-white/5 group">
            ...
            <p className="text-sm text-white/50 leading-relaxed">
              Receive personalized theological insight and prayer based on your life's context. Powered by Gemini 1.5 Pro, offering 24/7 spiritual guidance.
            </p>
          </div>
          <div className="glass p-8 space-y-4 hover:bg-white/5 transition-colors border border-white/5 group">
            ...
            <p className="text-sm text-white/50 leading-relaxed">
              Join thousands in synchronized prayer. Share requests securely with your private circle or the world and receive real-time notifications of intercession.
            </p>
          </div>
          <div className="glass p-8 space-y-4 hover:bg-white/5 transition-colors border border-white/5 group">
            ...
            <p className="text-sm text-white/50 leading-relaxed">
              Visualize scripture like never before. Generate high-definition Veo video meditations and immersive narratives that bring biblical stories to life.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="glass p-8 md:p-12 border-2 border-indigo-500/50 bg-indigo-900/10 relative transform md:scale-105 shadow-2xl">
              ...
              <button onClick={handleStart} className="w-full py-4 bg-indigo-600 text-white rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-indigo-500 shadow-lg transition-all">
