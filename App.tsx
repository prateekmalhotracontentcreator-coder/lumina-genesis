...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case AppView.COMMUNITY: return <CommunityHub />;
      case AppView.SETTINGS:
        return (
          <div className="space-y-6">
            ...
            <div className="glass p-4 bg-red-500/10 border-red-500/20 text-red-400 text-center font-bold text-sm cursor-pointer">Log Out</div>
            <div className="text-center">
              <button onClick={() => setActiveView(AppView.LANDING)} className="text-[10px] text-white/20 hover:text-white/40 uppercase tracking-widest">View Marketing Landing</button>
            </div>
          </div>
        );
