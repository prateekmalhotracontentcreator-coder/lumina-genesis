...
import { getAIChaplainAdvice } from './geminiService';
...
const AIChaplain: React.FC = () => {
  ...
  return (
    <div className="h-[75vh] flex flex-col glass p-4 shadow-2xl overflow-hidden bg-black/20">
      ...
      <div className="mt-4 pt-4 border-t border-white/10 flex gap-2">
        <input 
          ...
          className="flex-1 bg-black/20 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-white/30 outline-none text-white"
        />
        <button 
          onClick={handleSend}
          disabled={loading}
